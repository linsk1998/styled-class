...
export function dealCssProperty(key){
...
export function lighten(color:Color|number,amount:number, relative?:boolean){
...
export function darken(color:Color|number,amount:number, relative?:boolean){
	return lighten(color, -amount, relative);
}
export function spin(color:Color|number,amount){
	if(!(color instanceof Color)){
		color=Color.of(color);
	}
	var hsl=color.toHSL();
...
export function saturate(color:Color|number,amount,relative){
	if(!(color instanceof Color)){
		color=Color.of(color);
	}
	var hsl=color.toHSL();
...
export function desaturate(color:Color|number,amount,relative){
	return saturate(color, -amount, relative);
}
export function mix(color1:Color|number,color2:Color|number,weight?:number){
