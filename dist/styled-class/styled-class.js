...
export function setStyleInitor(fn) {
    styleInitor = fn;
}
...
export function oneObjectToCssRules(obj) {
    var r = {
        rules: obj,
        filters: [],
        needLayout: false,
...
export function gradient(start, end, toRight) {
    var g = new Gradient();
